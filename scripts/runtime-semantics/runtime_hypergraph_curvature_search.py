...
RESULTS_DIR = ROOT / "results" / "runtime-semantics" / "runtime-hypergraph-curvature"
DOCS_DIR = ROOT / "docs" / "writing" / "experiments" / "runtime-semantics"
...
def build_report(
    ...
    if note_path is not None:
        lines.append(f"- Note: [{note_path.name}](../../../docs/writing/experiments/runtime-semantics/{note_path.name})")
    return "\n".join(lines) + "\n"
