...
- [contract-representation-theorem.md](contract-representation-theorem.md)
- [witness-faithful-factorization.md](witness-faithful-factorization.md)
- [unique_minimal_referee.md](../../results/unique_minimal_referee.md)
- [phase_transition_sweep.md](../../results/phase_transition_sweep.md)
- [phase_transition_sweep.json](../../results/phase_transition_sweep.json)
...
The tower table in [phase_transition_sweep.md](../../results/phase_transition_sweep.md) now records the following counts.
